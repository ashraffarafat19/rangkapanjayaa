...
<tr>
    <td class="text-center">
      <div class="icheck-primary">
        <input type="checkbox" class="icheckbox_flat-blue " name="id_warga[]" value="<?php echo $warga->id_warga ?>">
    ...
    <td>
      <div class="btn-group">
        <a href="{{ asset('admin/warga/edit/'.$warga->id_warga) }}" 
          ...
          <a href="{{ asset('admin/warga/delete/'.$warga->id_warga) }}" class="btn btn-danger btn-sm delete-link"><i class="fa fa-trash"></i></a>
        </div>
    </td>
</tr>
